...
using UnityEngine.UI;
    ...
    /// </summary>
    [Preserve]
    public class GamepadIconCollection : MonoBehaviour
    {
        ...
        public Sprite GetControlSprite(string deviceLayoutName, string controlPath)
        {
            ...
            return null; // Return null if no matching device or control found
        }
