...
[CustomPropertyDrawer(typeof(HitDetectionBase), true)]
public class HitDetectionPropertyDrawer : PropertyDrawer
{
    ...
    private void ShowTypeSelectionMenu(SerializedProperty property)
    {
        ...
        foreach (var type in GetSubclassesOf<HitDetectionBase>())
        {
