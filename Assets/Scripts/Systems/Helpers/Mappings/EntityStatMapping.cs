...
[CreateAssetMenu(menuName = "Stats/Entity Stat Mapping", fileName = "NewEntityStatMapping")]
internal class EntityStatMapping : ScriptableObject
{
    ...
    public static EntityStatMapping Instance()
    {
        if (_instance == null)
        {
            _instance = Resources.Load("Configuration/" + typeof(EntityStatMapping).Name) as EntityStatMapping;
        }
        return _instance;
    }
